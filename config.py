...
class Config:
    ...
    video_azure_path: str       # Azure path template, e.g. openai/deployments/{deployment}/videos/generations
    ...
    def from_env(cls) -> "Config":
        return cls(
            ...
            video_azure_path=os.environ.get("VIDEO_AZURE_PATH", "openai/deployments/{deployment}/videos/generations"),
